...
public class ComparisionProcessor implements Processor {
    ...
    public void process(Exchange exchange) {
        ...
        Manifest manifest1 = bodyList.get(0).getIn().getBody(Manifest.class);
        Manifest manifest2 = bodyList.get(1).getIn().getBody(Manifest.class);
        ...
        Manifest diffManifest = ManifestUtil.differentiate(manifest1, manifest2);
